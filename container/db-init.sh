...
if [ "$SQL_SCRIPT" = "ag_primary.sql" ]
then
    rm /var/opt/mssql/shared/ag_certificate.key 2> /dev/null
    rm /var/opt/mssql/shared/ag_certificate.cert 2> /dev/null
fi
...
echo "#######      INIT_SCRIPT execution completed     #######"